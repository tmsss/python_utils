...
class ArticleManager(object):
    ...
    def clean_file(self, fname, remove, **kwargs):
        ...
        doc['text'] = lines.replace(remove, '')
        fx.save_pickle(self.directory + '\\' + fname, doc)

    def clean_files(self, remove, **kwargs):
        """
    ...
    def clean_directory(self, **kwargs):
        ...
        ### refazer listagem de ficheiros de modo a ter o nome completo do caminho para o ficheiro
